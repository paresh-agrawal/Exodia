...
public class LineFollower extends Fragment {
    ...
    private TextView round1, call_lineFollower_sanidhya, call_lineFollower_parinaya;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        description = (CardView)lineFollower.findViewById(R.id.description);
        contacts = (CardView)lineFollower.findViewById(R.id.contacts);
        call_lineFollower_parinaya =(TextView)lineFollower.findViewById(R.id.call_lineFollower_parinaya);
        call_lineFollower_sanidhya =(TextView)lineFollower.findViewById(R.id.call_lineFollower_sanidhya);
        round1 = (TextView)lineFollower.findViewById(R.id.lineFollower_round1_schedule_tv);
    ...
    private void call() {
        call_lineFollower_parinaya.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_DIAL, Uri.parse("tel:+919234567385")));
            }
        });
        call_lineFollower_sanidhya.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_DIAL, Uri.parse("tel:+919234567385")));
            }
    ...
    private void loadSchedule() {
        myFirebaseRef = new Firebase("https://exodia-1002f.firebaseio.com/Schdule/TechnicalEvents/LineFollower");
        getDataFromServer();
    }
