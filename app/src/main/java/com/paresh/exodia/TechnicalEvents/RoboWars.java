 ...
 */
public class RoboWars extends Fragment {

    private Firebase myFirebaseRef;
    public String value,value_taken;
    private TextView round1, call_roboWars_abhay, call_roboWars_kushagra;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contacts = (CardView)roboWars.findViewById(R.id.contacts);
        call_roboWars_kushagra =(TextView)roboWars.findViewById(R.id.call_roboWars_kushagra);
        call_roboWars_abhay =(TextView)roboWars.findViewById(R.id.call_roboWars_abhay);
        round1 = (TextView)roboWars.findViewById(R.id.roboWars_round1_schedule_tv);
    ...
    private void call() {
        call_roboWars_kushagra.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_DIAL, Uri.parse("tel:+919234567385")));
            }
        });
        call_roboWars_abhay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_DIAL, Uri.parse("tel:+919234567385")));
            }
    ...
    private void loadSchedule() {
        myFirebaseRef = new Firebase("https://exodia-1002f.firebaseio.com/Schdule/TechnicalEvents/RoboWars");
        getDataFromServer();
    }
